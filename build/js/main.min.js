...
var initDirectionsSlider = function initDirectionsSlider() {
  var swiper02 = document.querySelector('.swiper--02');
...
var initProjectsSlider = function initProjectsSlider() {
  var swiper07 = document.querySelector('.swiper--07');
  ...
  if (swiper07) {
    ...
    var nextBtn = swiper07.el.closest('.projects__cols').querySelector('.next-title__subtitle');
    nextBtn.textContent = swiper07.el.querySelector('.swiper-slide-next .projects__slider-item-subtitle').textContent;
    swiper07.on('slideChangeTransitionEnd', function () {
