...
/* harmony import */ var _modules_init_submenu__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/init-submenu */ "./js/modules/init-submenu.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_init_submenu__WEBPACK_IMPORTED_MODULE_4__["initSubmenu"])();
  ...
  return items.map(function (el, index) {
    if (activeIndex.length) {
      ...
      if (currentIndex === index) {
        return "<option ".concat(el.value ? "value=".concat(el.value.replace(' ', '&nbsp;', el.value)) : '', " selected>").concat(el.text ? "".concat(el.text) : '', "</option>");
      } else {
        return "<option ".concat(el.value ? "value=".concat(el.value.replace(' ', '&nbsp;', el.value)) : '', ">").concat(el.text ? "".concat(el.text) : '', "</option>");
      }
    } else {
      return "<option ".concat(el.value ? "value=".concat(el.value.replace(' ', '&nbsp;', el.value)) : '', ">").concat(el.text ? "".concat(el.text) : '', "</option>");
    }
...
var initProjectsMap = function initProjectsMap() {
  ...
  var locationIcon = [{
    ...
    balloonContentHeader: '<span>Россия. Москва,<br>Олимпийский проспект, 16с1</span>'
  }];
