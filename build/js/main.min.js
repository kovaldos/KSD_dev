...
var contactUsFormValidationSuccessCallback = function contactUsFormValidationSuccessCallback(e) {
  e.preventDefault();
  var formData = new FormData(e.target);
...
var initProjectsSlider = function initProjectsSlider() {
  ...
  if (projectSlider) {
    ...
    var nextBtn = projectSlider.el.closest('.projects__cols').querySelector('.next-title__subtitle');
