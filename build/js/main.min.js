...
var initTechnicSlider = function initTechnicSlider() {
  ...
  if (swiper06) {
    ...
    swiper06.el.querySelector('.technic__slider-btn-text--next').textContent = swiper06.el.querySelector('.swiper-slide-next .technic__slider-name').textContent; // swiper06.on('afterInit', () => {
