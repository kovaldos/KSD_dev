...
/* harmony import */ var _modules_init_calc_range_slider__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(/*! ./modules/init-calc-range-slider */ "./js/modules/init-calc-range-slider.js");
/* harmony import */ var _modules_init_techpark_slider__WEBPACK_IMPORTED_MODULE_27__ = __webpack_require__(/*! ./modules/init-techpark-slider */ "./js/modules/init-techpark-slider.js");
/* harmony import */ var _modules_init_hero_section_slider__WEBPACK_IMPORTED_MODULE_28__ = __webpack_require__(/*! ./modules/init-hero-section-slider */ "./js/modules/init-hero-section-slider.js");
/* harmony import */ var _modules_init_vehicle_card_slider__WEBPACK_IMPORTED_MODULE_29__ = __webpack_require__(/*! ./modules/init-vehicle-card-slider */ "./js/modules/init-vehicle-card-slider.js");
/* harmony import */ var _modules_init_video_slider__WEBPACK_IMPORTED_MODULE_30__ = __webpack_require__(/*! ./modules/init-video-slider */ "./js/modules/init-video-slider.js");
/* harmony import */ var _modules_init_recycling_items_slider__WEBPACK_IMPORTED_MODULE_31__ = __webpack_require__(/*! ./modules/init-recycling-items-slider */ "./js/modules/init-recycling-items-slider.js");
/* harmony import */ var _modules_we_need_slider__WEBPACK_IMPORTED_MODULE_32__ = __webpack_require__(/*! ./modules/we-need-slider */ "./js/modules/we-need-slider.js");
/* harmony import */ var _modules_init_work_with_us_slider__WEBPACK_IMPORTED_MODULE_33__ = __webpack_require__(/*! ./modules/init-work-with-us-slider */ "./js/modules/init-work-with-us-slider.js");
/* harmony import */ var _modules_init_directions_sup_slider__WEBPACK_IMPORTED_MODULE_34__ = __webpack_require__(/*! ./modules/init-directions-sup-slider */ "./js/modules/init-directions-sup-slider.js");
/* harmony import */ var _modules_init_rent_catalog_filter_mobile_js__WEBPACK_IMPORTED_MODULE_35__ = __webpack_require__(/*! ./modules/init-rent-catalog-filter-mobile.js */ "./js/modules/init-rent-catalog-filter-mobile.js.js");
/* harmony import */ var _modules_init_rent_card_similar_slider__WEBPACK_IMPORTED_MODULE_36__ = __webpack_require__(/*! ./modules/init-rent-card-similar-slider */ "./js/modules/init-rent-card-similar-slider.js");
/* harmony import */ var _modules_init_goods_slider__WEBPACK_IMPORTED_MODULE_37__ = __webpack_require__(/*! ./modules/init-goods-slider */ "./js/modules/init-goods-slider.js");
/* harmony import */ var _modules_init_ecology_slider__WEBPACK_IMPORTED_MODULE_38__ = __webpack_require__(/*! ./modules/init-ecology-slider */ "./js/modules/init-ecology-slider.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_init_hero_section_slider__WEBPACK_IMPORTED_MODULE_28__["initHeroSectionSlider"])(); // Modules
  // ---------------------------------
  ...
  window.addEventListener('load', function () {
    ...
    Object(_modules_init_calc_range_slider__WEBPACK_IMPORTED_MODULE_26__["initCalcRangeSlider"])();
    Object(_modules_init_techpark_slider__WEBPACK_IMPORTED_MODULE_27__["initTechparkSlider"])();
    Object(_modules_init_vehicle_card_slider__WEBPACK_IMPORTED_MODULE_29__["initVehicleCardSlider"])();
    Object(_modules_init_video_slider__WEBPACK_IMPORTED_MODULE_30__["initVideoSlider"])();
    Object(_modules_init_recycling_items_slider__WEBPACK_IMPORTED_MODULE_31__["initRecyclingItemsSlider"])();
    Object(_modules_we_need_slider__WEBPACK_IMPORTED_MODULE_32__["initWeNeedSlider"])();
    Object(_modules_init_work_with_us_slider__WEBPACK_IMPORTED_MODULE_33__["initWorkWithUsSlider"])();
    Object(_modules_init_directions_sup_slider__WEBPACK_IMPORTED_MODULE_34__["initDirectionsSupSlider"])();
    Object(_modules_init_rent_catalog_filter_mobile_js__WEBPACK_IMPORTED_MODULE_35__["initRentCatalogFilterMobile"])();
    Object(_modules_init_rent_card_similar_slider__WEBPACK_IMPORTED_MODULE_36__["initRentCardSimilarSlider"])();
    Object(_modules_init_goods_slider__WEBPACK_IMPORTED_MODULE_37__["initGoodsSlider"])();
    Object(_modules_init_ecology_slider__WEBPACK_IMPORTED_MODULE_38__["initEcologySlider"])();
  });
}); // ---------------------------------
...
/***/ "./js/modules/init-rent-card-similar-slider.js":
/*!*****************************************************!*\
  !*** ./js/modules/init-rent-card-similar-slider.js ***!
  \*****************************************************/
/*! exports provided: initRentCardSimilarSlider */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initRentCardSimilarSlider", function() { return initRentCardSimilarSlider; });
/* eslint-disable no-unused-vars */

/* eslint-disable no-undef */
// Слайдер в секции Команда -- Начало --
// Team slider -- Start --
var initRentCardSimilarSlider = function initRentCardSimilarSlider() {
  var rentCardSimilarSlider = document.querySelector('.rent-card-similar__slider');
...
var initRentCatalogFilterMobile = function initRentCatalogFilterMobile() {
  var rentCatalog = document.querySelector('.rent-catalog');

  if (rentCatalog) {
    var rentCatalogFilter = rentCatalog.querySelector('.rent-catalog__wrapper-col--01');
    var rentCatalogFilterToggle = rentCatalog.querySelector('.rent-catalog__filter-toggle');
    var rentCatalogFilterCancel = rentCatalog.querySelector('.rent-catalog__filter-cancel');
    var toggles = rentCatalog.querySelectorAll('.custom-toggle input[type="checkbox"]');
    ...
    var showChosen = function showChosen(target) {
      var tagsLists = rentCatalog.querySelectorAll('.rent-catalog__tags-list');
      ...
      tagsLists.forEach(function (tagList) {
        tagList.insertAdjacentHTML('beforeend', "\n\t\t\t\t\t<li class=\"rent-catalog__tags-list-item\">\n\t\t\t\t\t\t<span>".concat(tagText, "</span><span class=\"rent-catalog__tag-remove\">\uD83D\uDDD9</span>\n\t\t\t\t\t</li>\n\t\t\t\t"));
        var tags = tagList.querySelectorAll('.rent-catalog__tags-list-item');
    ...
    rentCatalog.addEventListener('click', function (e) {
      var target = e.target;
...
var initRentCatalogViewSwitch = function initRentCatalogViewSwitch() {
  var catalogWrap = document.querySelector('.rent-catalog');

  if (catalogWrap) {
    var btnStripes = catalogWrap.querySelector('.rent-catalog__nav-btn--stripes');
    var btnSquares = catalogWrap.querySelector('.rent-catalog__nav-btn--squares');
    var cardsWrapper = catalogWrap.querySelector('.rent-catalog__cards');
